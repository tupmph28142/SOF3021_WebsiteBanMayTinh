...
<body>
<form action="/chuc-vu/search" method="post" class="container">
...
<form action="/chuc-vu/view-add" class="container">
    ...
    <tbdoy>
        <c:forEach items="${listCV}" var="cv" varStatus="index">
            <tr>
                ...
                <td>
                    <a href="/chuc-vu/xoa/${cv.id}" class="btn btn-primary">Xoa</a>
                    <a class="btn btn-primary" href="/chuc-vu/detail/${cv.id}">Detail</a>
                    <a class="btn btn-primary" href="/chuc-vu/update/${cv.id}">Update</a>
